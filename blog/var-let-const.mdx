---
description: "자바스크립트(JavaScript)에서 변수를 선언하는 세 가지 방식 var, let, const에 대해 공부하고 정리한 것"
title: "자바스크립트(JavaScript)에서 변수를 선언하는 세 가지 방식"
tag: ["Javascript"]
date: "2021-02-10"
summary: "자바스크립트(JavaScript)에서 변수를 선언하는 세 가지 방식 var, let, const에 대해 공부하고 정리해보자"
---
...
- 자바스크립트에서는 모든 선언(var, let, const, function, function\*, class)을 **_호이스팅_**하기 때문이다.
